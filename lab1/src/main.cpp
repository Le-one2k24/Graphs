        ...
        switch(choice){
            case 1: {
                ...
                for (int attempt = 0; attempt < 20; ++attempt){
                    ...
                    // проверка связности (ориентированная: считаем связным если неориентированно связен)
                    bool* vis = new bool[N];
            ...
            case 2: {
                ...
                // симметризация матрицы смежности
                ...
                // симметризация весовой матрицы, если она существует
